...
export class DataTableComponent implements OnInit {
    ...
    ngOnInit() {
        console.log('this.docs[0].nameINIT', this.docs[0].name);

        this.dataTable = {
            headerRow: ['Nome', 'Categoria', 'Azienda', 'Tipologia', 'Actions'],
            footerRow: ['Nome', 'Categoria', 'Azienda', 'Tipologia', 'Actions'],
            dataRows:  ['OO', this.docs[0].name]
